...
public class OAuthenicationSuccessHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(
        ...
        if (authorizedClientRegistrationId.equalsIgnoreCase("google")) {
            ...
            user.setProfilePhoto(oAuth2User.getAttribute("picture") != null ? oAuth2User.getAttribute("picture") : "");
            user.setEmail(email);
            user.setProviderUserId(oAuth2User.getAttribute("sub") != null ? oAuth2User.getAttribute("sub") : "");
